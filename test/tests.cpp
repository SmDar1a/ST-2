...
TEST(Smirnova_Test_Circle, radius_constructor) {
    Circle circle1(20);
...
TEST(Smirnova_Test_Circle, area_setter) {
    Circle circle1;
    Circle circle2;
    Circle circle3;
    Circle circle4;
...
TEST(Smirnova_Test_Circle, ference_setter) {
    Circle circle1;
    Circle circle2;
    Circle circle3;
    Circle circle4;
...
TEST(Smirnova_Test_Circle, check_area_after_setting_radius) {
    Circle circle1;
...
TEST(Smirnova_Tasks, swimming_pool) {
